...
function useModel(user:Identity){
 ...
 return {user,db,commands,menu,settings,orders,shifts,shift,movements,stockItems,cash,outbox,lastSync:lastSync?.value,notice,error,busy,online,act,sync,setNotice,setError,manager:user.role!=='cashier'}
}
